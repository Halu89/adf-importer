...
import ForgeReconciler, {Box, Button, ModalTransition, Stack, Text} from "@forge/react";
import {QueryClientProvider, queryOptions, useQuery, useQueryClient} from "@tanstack/react-query";
        ...
        return (
            <Stack space={"space.100"}>
                {isLoading ? <Text>Loading...</Text> :
                    <Text>Currently saving pages to space &apos;{spaceSetting?.name}&apos;</Text>}
                ...
                <ModalTransition>
                    {edit && (
                        <GlobalSettingsEdit onSubmit={handleSubmit} closeModal={closeModal}/>
                    )}
                </ModalTransition>
            </Stack>
        );
